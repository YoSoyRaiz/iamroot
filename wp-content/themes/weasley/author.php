...
get_header(); ?>
<?php if(isset($weasley_redux_demo['auth_bg_light']['url']) && $weasley_redux_demo['auth_bg_light']['url'] != ''){?>
<section class="section dark-bg bg-theme logo-bg-light" style="background-image: url('<?php echo esc_url($weasley_redux_demo['auth_bg_light']['url']); ?>');">
<?php }else{?>
<section class="section dark-bg bg-theme logo-bg-light">
<?php }?>
	<div class="container">
		<div class="section-heading text-center">
			<?php if(isset($weasley_redux_demo['auth_title']) && $weasley_redux_demo['auth_title']){?>
				<h2><?php echo esc_attr($weasley_redux_demo['auth_title']);?></h2>
			<?php }else{?>
				<h2><?php echo esc_html__( 'All post by author', 'weasley' );?></h2>
			<?php } ?>
			<span class="cap"><?php printf( esc_html__( ' %s', 'weasley' ), get_the_author() );?></span>
		</div>
	</div>
</section>

<?php if(isset($weasley_redux_demo['auth_bg_dark']['url']) && $weasley_redux_demo['auth_bg_dark']['url'] != ''){?>
<section class="section dark-bg bg-theme logo-bg-dark" style="background-image: url('<?php echo esc_url($weasley_redux_demo['auth_bg_dark']['url']); ?>');">
<?php }else{?>
