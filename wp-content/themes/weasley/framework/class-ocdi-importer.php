	...
	public function import_files_config() {
		...
		$home_prevs = array(
			'medinet_home_1' => array(
				'title' => __( 'Import weasley', 'weasley' ),
				'page'  => __( 'Home 1 White', 'weasley' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/screenshot.png',
				'preview_link' => 'https://shtheme.com/demosd/weasley/',
			),
			'medinet_home_2' => array(
				'title' => __( 'Import weasley Home Dark', 'weasley' ),
				'page'  => __( 'Home 1 Dark', 'weasley' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/screenshot.png',
				'preview_link' => 'https://shtheme.com/demosd/weasley/?page_id=262',
			),
			'medinet_home_3' => array(
				'title' => __( 'Import weasley Home 2 White', 'weasley' ),
				'page'  => __( 'Home 2 White', 'weasley' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/screenshot.png',
				'preview_link' => 'https://shtheme.com/demosd/weasley/?page_id=229',
			),
			'medinet_home_4' => array(
				'title' => __( 'Import weasley Home 2 Dark', 'weasley' ),
				'page'  => __( 'Home 2 Dark', 'weasley' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/screenshot.png',
				'preview_link' => 'https://shtheme.com/demosd/weasley/?page_id=268',
			),
		);
		...
		foreach ( $home_prevs as $key => $prev ) {
			...
			$config[] = array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'weasley' ),
			);
		}
