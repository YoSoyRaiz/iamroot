 ...
 * @since 1.0.0
 */
class BdevsPortfolioSection2 extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-portfolio-section-2';
	}
	...
	public function get_title() {
		return __( 'Portfolio Section 2', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'portfoliosection2', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_portfolio_section_2',
			[
				'label' => esc_html__( 'Portfolio Section 2', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'tabs',
...
<div class="row portfolio-content lightbox-gallery">
	<?php
	foreach ( $settings['tabs'] as $item ) :
	?>
		<div class="grid-item product col-sm-6 col-lg-4 branding">
