 ...
 * @since 1.0.0
 */
class BdevsAboutText2 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'About Text 2', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_about_text_2',
			[
				'label' => esc_html__( 'About Text 2', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'title',
		...
		$this->add_control(
			...
			[
				...
				'fields' => [
					...
					[
						'name'        => 'sub_item',
						'label'       => esc_html__( 'Sub Item', 'bdevs-elementor' ),
						'type'        => Controls_Manager::TEXTAREA,
						'dynamic'     => [ 'active' => true ],
						'default'     => esc_html__( '' , 'bdevs-elementor' ),
						'label_block' => true,
	...
	<div class="row g-4">
		...
		?>
			<div class="col-6">
				...
				<?php endif ?>
				<?php if ('' != $item['sub_item']): ?>
					<small><?php echo wp_kses_post($item['sub_item']); ?></small>
				<?php endif ?>
			</div>
		<?php endforeach; ?>
	</div>
