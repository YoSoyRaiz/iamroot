 ...
 * @since 1.0.0
 */
class BdevsServices2Section extends \Elementor\Widget_Base {
	...
	public function get_name() {
		return 'bdevs-services2-section';
	}
	...
	public function get_title() {
		return __( 'Services 2 Section', 'bdevs-elementor' );
	}
	...
	public function get_keywords() {
		return [ 'services2section', 'carousel' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_services2_section',
			[
				'label' => esc_html__( 'Services 2 Section', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'tabs',
