 ...
 * @since 1.0.0
 */
class BdevsAboutText1 extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'About Text 1', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_about_text_1',
			[
				'label' => esc_html__( 'About Text 1', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'title',
